...
var surveys = {"surveys": [ 
    {id: "0", type: "base", description: "Base survey",
	 ...
	 {id: "68", question: "Apakah air yang anda gunakan untuk membuat teh/kopi?", type: "2", options: ["AQUA/AIR MINERAL, ETC", "AIR KRAN/PAM", "SUMUR/POMPA (LISTRIK, TANGAN)", "AIR SUMUR", "AIR ISI ULANG", "LAINNYA"]},
	 ...
	 {id: "73", question: "Apakah anak BAPAK/IBU terbiasa mencuci tangan sebelum makan", type: "2", options: ["ya","tidak"]},
	 {id: "74", question: "Apakah anak BAPAK/IBU terbiasa mencuci tangan setelah bermain?", type: "2", options: ["ya","tidak"]},
	 {id: "75", question: "Bisa tolong tunjukkan dimana BAPAK/IBU menyimpan air. Tempatnya berupa?", type: "2", options: ["Tong bermulut terbuka (seperti ember, panci masak, mangkok)", "Cerek atau tempat air yang digunakan berulang dengan mulut", "Botol air sekali pakai dengan mulut tertutup", "Galon/kontener dengan kran", "lainnya"]},
	 {id: "76", question: "Berapa lama waktu terlama BAPAK/IBU menyimpan air minum sebelum diminum?", type: "2", options: ["Kadang-kadang Lebih dari seminggu", "Antara tiga hari sampai seminggu", " Dua atau tiga hari", "Cuma satu hari", "Selalu kurang dari satu hari"]},
	 {id: "77", question: "Berapa banyak air yang dikonsumsi oleh masing-masing anggota keluarga dalam satu hari?  (berapa liter -- semua air atau air biasa)", type: "1"},
	 {id: "78", question: "Berapa banyak air minuman yang dikonsumsi oleh masing-masing anggota keluarga dalam satu hari?  (berapa liter)", type: "1"},
	 {id: "79", question: "Siapa yang bertanggung jawab terhadap air (mengumpulkan, membayar, menyimpan, dll) untuk keluarga BAPAK/IBU (hubungannya dengan anak)?", type: "2", options: ["ibu", "ayah", "nenek/kakek", "saudara", "Lebih dari satu orang dalam keluarga", "lainnya"]},
	 {id: "80", question: "Apakah BAPAK/IBU senang dengan kualitas air yang BAPAK/IBU gunakan untuk minum?", type: "2", options: [" Sangat senang!", "senang", "Kadang-kadang saya punya masalah tentang air", "Saya tidak senang dengan air yang harus saya minum.  ", "Saya tidak memikirkan tentang kualitas air yang saya minum.  ", "lainnya"]},
	 {id: "81", question: "Menurut BAPAK/IBU kualitas air penting untuk kesehatan anak-anak?  ", type: "2", options: ["ya","tidak", "tidak tahu"]},
	 {id: "82", question: "Menurut BAPAK/IBU apakah air yang BAPAK/IBU gunakan ada kaitan dengan masalah kesehatan anak BAPAK/IBU?", type: "2", options: ["ya","tidak", "tidak tahu"]},
	 {id: "83", question: "BAB anknya yang lalu bagaimana??", type: "2", options: ["tipe 1", "tipe 2", "tipe 3", "tipe 4", "tipe 5", "tipe 6", "tipe 7"]},
	 {id: "84", question: "Bahasa apa yang BAPAK/IBU gunakan untuk percakapan sehari-hari di rumah?", type: "2", options: ["Indonesia", "Java", "Sunda", "Cina", "Minang", "Bali", "Batak", "Makassar", "Toraja", "betawI", "Melayu", "Ambon", "Manado", "Aceh", "Banten",  "Cirebon",  "Lainnya"]},
	 {id: "85", question: "Apa suku BAPAK ANAKNYA?", type: "2", options: ["Java", "Sunda", "Cina", "Minang", "Bali", "Batak", "Makassar", "Toraja", "betawI", "Melayu", "Ambon", "Manado", "Aceh", "Banten",  "Cirebon",  "Lainnya"]},
	 {id: "86", question: "Apa suku IBU ANAKNYA?", type: "2", options: ["Java", "Sunda", "Cina", "Minang", "Bali", "Batak", "Makassar", "Toraja", "betawI", "Melayu", "Ambon", "Manado", "Aceh", "Banten",  "Cirebon",  "Lainnya"]},
	 {id: "87", question: "Suku mana yang sangat berpengaruh dalam kehidupan sehari-hari di rumah?", type: "2", options: ["Java", "Sunda", "Cina", "Minang", "Bali", "Batak", "Makassar", "Toraja", "betawI", "Melayu", "Ambon", "Manado", "Aceh", "Banten",  "Cirebon",  "Lainnya"]},
	 {id: "88", question: "Apakah BAPAK/IBU bisa membaca koran berbahasa Indonesia?", type: "2", options: ["ya","tidak"]},
	 {id: "89", question: "Apakah BAPAK/IBU bisa membaca koran dalam bahasa lain?", type: "2", options: ["ya","tidak"]},
	 {id: "90", question: "Apakah BAPAK/IBU bisa menulis surat dalam bahasa Indonesia?", type: "2", options: ["ya","tidak"]},
	 {id: "91", question: "Apakah BAPAK/IBU bisa menulis surat dalam bahasa lain?", type: "2", options: ["ya","tidak"]},
	 {id: "92", question: "Apakah BAPAK/IBU pernah bersekolah?", type: "2", options: ["ya","tidak"]},
	 {id: "93", question: "Apa tingkat pendidikan tertinggi BAPAK/IBU?", type: "2", options: ["SD", "SMP", "SMK", "SMA", "SMU", "Diploma", "Universitas S1", "Universitas S2", "Universitas S3", "Tidak skolah"]},
	 {id: "94", question: "SIAPA SAJA (ORANG LAIN) DISAMPING RESPONDEN YANG HADIR PADA SAAT .  INTERVIEW? ", type: "2", options: ["TIDAK SEORANG PUN", "ANAK UMUR 5 TAHUN ATAU KURANG", "ANAK UMUR LEBIH DARI 5 TAHUN", "Suami/Istri", "ORANG DEWASA, ANGGOTA KELUARGA", "ORANG DEWASA, BUKAN ANGGOTA KELUARGA"]},
	 {id: "95", question: "BAGAIMANA PENILAIAN ANDA TERHADAP KEAKURATAN JAWABAN YANG DIBERI OLEH RESPONDEN?", type: "2", options: ["Bagus sekali!", "bagus", "biasa", "kurang bagus", "jelek"]},
	 {id: "96", question: "BAGAIMANA PENILAIAN ANDA TENTANG KESERIUSAN DAN PERHATIAN RESPONDEN?", type: "2", options: ["Bagus sekali!", "bagus", "biasa", "kurang bagus", "jelek"]},
	 {id: "97", question: "PERTANYAAN YANG MANA YANG DIANGGAP SULIT, MEMALUKAN, DAN MEMBINGUNGKAN OLEH RESPONDEN?", type: "1"},
	 {id: "98", question: "PERTANYAAN YANG MANA YANG DIANGGAP SULIT, MEMALUKAN, DAN MEMBINGUNGKAN OLEH INTERVIEWER?", type: "1"},
	 {id: "99", question: "PERTANYAAN YANG MANA YANG KELIHATANNYA MENARIK BAGI RESPONDEN?", type: "1"},
	 {id: "100", question: "WAKTU SELESAI", type: "1"},
	 {id: "101", question: "Interview seluruhnya/sebagian besar dilakukan dengan menggunakan bahasa apa?", type: "1"},
	 {id: "102", question: "Bahasa lain yang digunakan (jika ada):", type: "1"},
     ], },
